...
//Cuantas peliculas en ingles hay en ele arreglo peliculas
...
//console.log(`Películas en inglés ${peliculasEnIngles()}`);


// Función que imporime los generos que tiene una pelicula
//COmo parametro, pasar el titulo (original_title de la pelicula) 
...
printGenresByTitleMovie("Mulan");


//Funcion que imprime las peliculas que tengan la mayor y menor cantidad de votos(vote_count)

const mayorYmenor = () => {

}

// Función que imprime las peliculas (ojetos) que tengan la mayor cantidad de generos

//ejemplo : Si la pelicula que mas generos tenga es 5 generos, mostrar todas las peliculas que tengas 5 generos.

const mayorCantidadDeGeneros = () => {

}

// Funcion que reotorna un arreglo de peliculas con cada objeto que tenga el atributo "generos" que va a ser un arreglo de strings con los generos de la pelicula

//ejemplo : ["drama", "acción", "aventura"]

// cada objeto pelicula debe tener todos los atributos originales del arreglo
//"peliculas" más el atributo generos
//HINT : usar map
